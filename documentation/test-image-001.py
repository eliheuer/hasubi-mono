# Basic usage example, from a Unix terminal:
# $ git clone my-font
# $ cd my-font
...
BIG_TEXT_A = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
BIG_TEXT_B = "abcdefghijklmnopqrstuvwxyz"
BIG_TEXT_C = "0123456789"
BIG_TEXT_FONT_SIZE = 1024/8
...
def draw_main_text():
    ...
    font("fonts/RecMono.ttf")
    fontSize(BIG_TEXT_FONT_SIZE)
    text(BIG_TEXT_A, (BIG_TEXT_SIDE_MARGIN, BIG_TEXT_BOTTOM_MARGIN*2))

    #font(FONT_PATH)
    font("fonts/InputMonoCompressed-Regular.ttf")
    fontSize(BIG_TEXT_FONT_SIZE)
    fontVariations(wght = 400)
    text(BIG_TEXT_B, (BIG_TEXT_SIDE_MARGIN, BIG_TEXT_BOTTOM_MARGIN - MARGIN*3))

    font(FONT_PATH)
    fontSize(BIG_TEXT_FONT_SIZE)
    fontVariations(wght = 400)
    text(BIG_TEXT_B, (BIG_TEXT_SIDE_MARGIN, BIG_TEXT_BOTTOM_MARGIN - MARGIN*4))

    #font(FONT_PATH)
    font("fonts/InputMonoCompressed-Regular.ttf")
    fontSize(BIG_TEXT_FONT_SIZE)
    fontVariations(wght = 400)
    text(BIG_TEXT_A, (BIG_TEXT_SIDE_MARGIN, BIG_TEXT_BOTTOM_MARGIN - MARGIN*5))

    font(FONT_PATH)
    fontSize(BIG_TEXT_FONT_SIZE)
    fontVariations(wght = 400)
    text(BIG_TEXT_A, (BIG_TEXT_SIDE_MARGIN, BIG_TEXT_BOTTOM_MARGIN - MARGIN*6))

    #font(FONT_PATH)
    font("fonts/InputMonoCompressed-Regular.ttf")
    fontSize(BIG_TEXT_FONT_SIZE)
    fontVariations(wght = 400)
    text(BIG_TEXT_C, (BIG_TEXT_SIDE_MARGIN, BIG_TEXT_BOTTOM_MARGIN - MARGIN*7))

    font(FONT_PATH)
    fontSize(BIG_TEXT_FONT_SIZE)
    fontVariations(wght = 400)
    text(BIG_TEXT_C, (BIG_TEXT_SIDE_MARGIN, BIG_TEXT_BOTTOM_MARGIN - MARGIN*8))

    font(FONT_PATH)
    fontSize(BIG_TEXT_FONT_SIZE)
    fontVariations(wght = 400)
    #text(BIG_TEXT_B, (BIG_TEXT_SIDE_MARGIN, BIG_TEXT_BOTTOM_MARGIN - MARGIN*2))
