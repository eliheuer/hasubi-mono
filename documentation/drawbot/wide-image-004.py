...
def draw_main_text():
    ...
    text("أنت الكافي وأنت الشافي وأنت الباقي يا باقي", ((MARGIN-4)+MARGIN*13.55, (TOP_TEXT)-(LEADING*2)))
    text("بــــــــك يا سلطان بك يا رفعان بك يا ديان", ((MARGIN-4)+MARGIN*13.55, (TOP_TEXT)-(LEADING*3)))
    text("أنت الكافي وأنت الشافي وأنت الباقي يا باقي", ((MARGIN-4)+MARGIN*13.55, (TOP_TEXT)-(LEADING*4)))
    text("بـــــــــــــك يا أحد بك يا صمد بك يا فرد", ((MARGIN-4)+MARGIN*13.55, (TOP_TEXT)-(LEADING*5)))
    text("أنت الكافي وأنت الشافي وأنت الباقي يا باقي", ((MARGIN-4)+MARGIN*13.55, (TOP_TEXT)-(LEADING*6)))
