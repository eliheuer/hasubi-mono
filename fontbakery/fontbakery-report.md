...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* Yacute (U+00DD): X=269.0,Y=938.0 (should be at ascender 940?)

	* Yacute (U+00DD): X=361.0,Y=938.0 (should be at ascender 940?)
	...
	* Ycircumflex (U+0176): X=200.0,Y=938.0 (should be at ascender 940?)

	* Ycircumflex (U+0176): X=296.0,Y=938.0 (should be at ascender 940?)

	* Zacute (U+0179): X=286.0,Y=938.0 (should be at ascender 940?)

	* Zacute (U+0179): X=378.0,Y=938.0 (should be at ascender 940?)

	* Zcaron (U+017D): X=137.0,Y=942.0 (should be at ascender 940?)

	* Zcaron (U+017D): X=185.0,Y=942.0 (should be at ascender 940?)

	* Zcaron (U+017D): X=345.0,Y=942.0 (should be at ascender 940?)

	* Zcaron (U+017D): X=393.0,Y=942.0 (should be at ascender 940?)
	...
	* Ygrave (U+1EF2): X=143.0,Y=938.0 (should be at ascender 940?) 

	* And Ygrave (U+1EF2): X=235.0,Y=938.0 (should be at ascender 940?) [code: found-misalignments]
</div></details><details><summary>⚠ <b>WARN:</b> Do any segments have colinear vectors? (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/<Section: Outline Correctness Checks>.html#com.google.fonts/check/outline_colinear_vectors">com.google.fonts/check/outline_colinear_vectors</a>)</summary><div>
